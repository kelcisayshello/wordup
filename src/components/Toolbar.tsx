...
export default function Toolbar() {
    ...
    function clearArea() {
        let choice = confirm("🧹 Do you want to clear all text input?");
    ...
    return (
        <>
            <div className="toolbar-container">
                <p className='words stats'>words: <span id='wrdCount'>44</span></p>
                <p className='characters stats'>characters: <span id='charCount'>1093</span></p>
                <Toggle />
                <button onClick={copyFunction} ref={ref} className='copy stats'>
                ...
                <button onClick={clearArea} ref={ref} className='clear stats'>
